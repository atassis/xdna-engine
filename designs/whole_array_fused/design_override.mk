...
##===----------------------------------------------------------------------===##
#
# Shared override for the whole_array matmul FAMILY (mm.cc + emulate/bfp16
...
# relative path, e.g. `include ${srcdir}/../../../../../designs/whole_array_fused/design_override.mk`.
#
...
# level further up than the old aie_kernels/.
# Makefile that includes it, whatever its own srcdir depth.
lib_kernels_dir := $(abspath $(dir $(lastword $(MAKEFILE_LIST)))../../aie_kernels)

# Our kernels include vendor headers by a path relative to the VENDOR tree
# (mm_silu_epilogue.cc: #include "../aie_kernel_utils.h"). Compiled from lib_kernels_dir that
