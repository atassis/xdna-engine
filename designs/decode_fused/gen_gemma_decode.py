...
Mirrors the two proven references:
  * designs/decode_fused/gen_decode.py  -- Whisper fused decode: the deep-C scratchpad KV
...
Run INSIDE the fork IRON env (scripts/toolchain_up.sh). Example:
  python designs/decode_fused/gen_gemma_decode.py --weights <dumped_gemma_270m> \
