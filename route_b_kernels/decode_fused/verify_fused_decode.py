...
def main():
    ...
    o_ms = Softmax(rows=16, cols=S, num_aie_columns=1, num_channels=1, rtp_vector_size=SM_MAGIC, context=ctx)
    ...
    o_mc = Softmax(rows=16, cols=TP, num_aie_columns=1, num_channels=1, rtp_vector_size=T, context=ctx)
