...
def _str2bool(v):
    ...
    # otherwise wrongly select the bfp16 microkernel dims. The rewritten upstream
    # makefile-common always passes --emulate-bf16-mmul-with-bfp16 {0|1} (the old
    # one omitted it for the native case), so this generator must accept "0".
