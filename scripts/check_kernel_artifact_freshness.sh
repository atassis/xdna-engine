...
echo "[check_kernel_artifact_freshness] NOT COVERED: artifacts/relpos, artifacts/conveyor -- no .toolchain-stamp mechanism exists for either family. A clean run above is NOT evidence those two are fresh."
