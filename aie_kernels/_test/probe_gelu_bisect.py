...
aie_kernels/snake/snake.cc is a counterexample that rules out EITHER alone: snake_f32
...
Run under the device lock (from aie_kernels/_test/): ./run.sh probe_gelu_bisect.py
"""
