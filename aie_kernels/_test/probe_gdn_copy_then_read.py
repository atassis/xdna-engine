...
# lived at aie_kernels/. Rewriting it to the current aie_kernels/ path breaks it.
src = subprocess.run(["git", "show", f"{PRE_FIX_REV}:aie_kernels/gatedeltanet/gatedeltanet.cc"],
