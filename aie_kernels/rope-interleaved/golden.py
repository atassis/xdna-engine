...
"""Host reference (numpy) for the rope-interleaved brick (aie_kernels/rope-interleaved).

CORRECTS aie_kernels/rope-lut, which implements split-half (GPT-NeoX/Llama) rotation.
