...
pub const FLAGS: &[Flag] = &[
    ...
    Flag { name: "WHISPER_ENC_HOST", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:317",
        ...
        doc: "runs the Whisper encoder on host ONNX instead of the NPU; opt-in, loud (never a \
              silent fallback)." },
    Flag { name: "NPU_DECODE_FUSED", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:334",
        semantics: IsOk, default: "false",
        doc: "whole 12-layer fused-ELF decode backend (1 dispatch/token); takes precedence over NPU_DECODE." },
    Flag { name: "NPU_DECODE", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:335",
        semantics: IsOk, default: "false",
        doc: "per-op NPU decode backend (~72 dispatches/token), used when NPU_DECODE_FUSED is unset." },
    Flag { name: "NPU_DECODE_FUSED_BATCH", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:336",
        semantics: IsOk, default: "false",
        doc: "batched/offline-bulk fused decoder subsystem, independent of the single-stream backend." },
    Flag { name: "NPU_DECODE_FUSED_BATCH_DIR", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:349",
    ...
    Flag { name: "NPU_DECODE_FUSED_DIR", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:364",
    ...
    Flag { name: "WHISPER_LANG_PIN", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:825",
        semantics: IsOk, default: "false",
    ...
    Flag { name: "WHISPER_TIMING", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:848",
        semantics: IsOk, default: "false",
        doc: "per-stage (prep/encode/decode) wall-clock timing for one transcribe window." },
    Flag { name: "NPU_DEBUG_TOKEN_IDS", owner: "npu-engine", site: "npu-engine/src/asr/whisper.rs:897",
        semantics: IsOk, default: "false",
    ...
    Flag { name: "PARAKEET_RESIDENT_MHA", owner: "npu-parakeet", site: "npu-parakeet/src/encoder.rs:386",
        ...
        doc: "resident on-chip multi-head attention. Read via resident_on() (dynamic name); also \
              checked at line 540." },
    Flag { name: "PARAKEET_RESIDENT_CONV", owner: "npu-parakeet", site: "npu-parakeet/src/encoder.rs:776",
        semantics: NotZero, default: "true (also requires !hybrid())",
        doc: "resident on-chip conv module. Read via resident_on() (dynamic name)." },
    Flag { name: "PARAKEET_RESIDENT_SILU", owner: "npu-parakeet", site: "npu-parakeet/src/encoder.rs:778",
        semantics: NotZero, default: "true (also requires !hybrid())",
        doc: "resident on-chip SiLU activation. Read via resident_on() (dynamic name)." },
    Flag { name: "PARAKEET_FUSED_BLOCK", owner: "npu-parakeet", site: "npu-parakeet/src/encoder.rs:947",
        semantics: NotZero, default: "true (also requires !hybrid())",
    ...
    Flag { name: "PARAKEET_RELPOS_ROWTILE", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:179",
        semantics: Presence, default: "false",
        doc: "selects the row-tiled relpos bucket table (must match the artifact set PARAKEET_RELPOS_DIR names)." },
    Flag { name: "PARAKEET_RELPOS_NOPEEL", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:181",
        semantics: Presence, default: "false",
        doc: "selects the no-peel relpos bucket table; only checked when ROWTILE is unset." },
    Flag { name: "PARAKEET_LN_MODE", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:688",
        semantics: NotZero, default: "false",
    ...
    Flag { name: "PARAKEET_MODAL_EPI_SUFFIX", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:701",
    ...
    Flag { name: "PARAKEET_FOLD_FC1", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:762",
        semantics: NotZero, default: "false",
        doc: "folds fc1 into the resident modal xclbin (prices folding fc1 into the modal path)." },
    Flag { name: "PARAKEET_FOLD_GLU", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:777",
        semantics: NotZero, default: "false",
        doc: "folds GLU into the pw1 resident dispatch." },
    Flag { name: "NPU_NATIVE", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:847",
        semantics: IsOk, default: "false",
        doc: "native bf16 32x32x32 resident tile instead of the default fast-bfp16 64x32x128." },
    Flag { name: "NPU_RESIDENT_XCLBIN", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:868",
    ...
    Flag { name: "PARAKEET_RELPOS_DIR", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:973",
    ...
    Flag { name: "PARAKEET_RELPOS_NO_BUCKET", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:1029",
        semantics: Presence, default: "false",
        doc: "forces the ceiling relpos bucket for every clip (pre-T-bucketing baseline, A/B)." },
    Flag { name: "PARAKEET_RELPOS_2BUCKET", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:1034",
        semantics: Presence, default: "false",
    ...
    Flag { name: "PARAKEET_RELPOS_TACTIVE_PROBE", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:1165",
        semantics: Value, default: "unset",
    ...
    Flag { name: "PARAKEET_LN_FUSED", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:1519",
        semantics: NotZero, default: "true",
        doc: "fused ctxLN->affine_cast dispatch when built; =0 forces the two-dispatch chain back." },
    Flag { name: "PARAKEET_FC2_ONEDISPATCH", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:2843",
        semantics: NotZero, default: "true",
    ...
    Flag { name: "PARAKEET_FC2_K4096", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:2892",
        semantics: NotZero, default: "false",
        doc: "one-dispatch K=DFF (4096) fc2 collapse (opt-in)." },
    Flag { name: "PARAKEET_FC1_PACK_IN_DRAIN", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:2897",
        semantics: NotZero, default: "true",
