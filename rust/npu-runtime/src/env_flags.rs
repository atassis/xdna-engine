...
pub const FLAGS: &[Flag] = &[
    ...
    Flag { name: "NPU_QUIET", owner: "npu-cli", site: "npu-cli/src/main.rs:101",
    ...
    Flag { name: "XDNA_ENGINE_ROOT", owner: "npu-cli", site: "npu-cli/src/main.rs:124",
    ...
    Flag { name: "XDG_DATA_HOME", owner: "npu-cli", site: "npu-cli/src/main.rs:128",
        semantics: Value, default: "$HOME/.local/share",
        doc: "XDG data-home candidate for the install root when XDNA_ENGINE_ROOT is unset." },
    Flag { name: "NPU_ASR_MAX_SPAN_S", owner: "npu-cli", site: "npu-cli/src/main.rs:646",
    ...
    Flag { name: "PARAKEET_FC2_ONEDISPATCH", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:2918",
        semantics: NotZero, default: "true",
    ...
    Flag { name: "PARAKEET_FC2_K4096", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:2967",
        semantics: NotZero, default: "false",
        doc: "one-dispatch K=DFF (4096) fc2 collapse (opt-in)." },
    Flag { name: "PARAKEET_FC1_PACK_IN_DRAIN", owner: "npu-parakeet", site: "npu-parakeet/src/npu.rs:2972",
        semantics: NotZero, default: "true",
